    ...
    <div className="container prelative" style={{ border: "2px solid #eee" }}>
          ...
          <div className="slideleft">
            ...
            <CVObject1 name="CONTACT">
              ...
              <ObjectItem1 icon={ImageLocation}>
                58/ đường số 6 Tăng Nhơn phú b, Quận 9
              </ObjectItem1>
        ...
        <div className="col-lg-9">
          ...
          <div className="lr-body1">
            <CVObject2 name="EDUCATION">
              ...
              <h5>University of Science | 2015 - 2019</h5>
              <div>
                GPA/10: 7.54 (Details:{" "}
                <span
                  className="textLink"
              ...
              <div>I have completed the school program.</div>
            </CVObject2>
            <CVObject2 name="OBJECTIVE">
              ...
              <Panel1>
                I want to be a good Frontend web developer and use English
                better
              </Panel1>
            </CVObject2>
      ...
      <div style={{ paddingLeft: 15 }}>
        <CVObject2 name="ACTIVITIES">
          ...
          />
          <ObjectItem2
            title="JOIN RUN FOR THE HEART 2018"
            position="member"
            year="2018 - 2018"
          />
        </CVObject2>
        <CVObject2 name="PROJECTS">
            ...
            <ul style={{ listStyleType: "none", padding: 0 }}>
              ...
              <li>
                ...
                <span
                  ...
                  onClick={() =>
                    window.open(
                      "  https://dvth-web-todolist-01.000webhostapp.com/",
                      "_blank"
                    )
                  }
                >
          ...
          <ObjectItem3>
            ...
            <ul style={{ listStyleType: "none", padding: 0 }}>
              ...
              <li style={{ marginLeft: 20, listStyleType: "disc" }}>
                User side: Manage your credit card (including: transfer function
                for other accounts, view transaction history)
              </li>
              ...
              <li>
                ...
                <span
                  className="textLink"
                  onClick={() =>
                    window.open("https://codesandbox.io/s/kk5ypj6lj3", "_blank")
                  }
                >
          ...
          <ObjectItem3>
            <h3 className="titleColor">APPLICATION SUPPORTING WORKING GROUP</h3>
            <h6>2019 - 2019</h6>
            <ul style={{ listStyleType: "none", padding: 0 }}>
              <li>
                Content: TASM is an application that supports job management in
                a project. Besides, it also helps users more convenient with the
                Chat and Call functions to bring the most convenience to users.
                TASM is a combination of many features of individual
                applications. It encapsulates the most quintessential things to
                create the most unique thing.{" "}
              </li>
              <li>
                Description: Graduation project, The application will be slow at
                the first run by the server for free. You can create an account
